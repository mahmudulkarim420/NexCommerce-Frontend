...
import {
  ...
  createAddress,
  updateAddress,
} from "@/src/hook/useAuth";
import { clearUser, userget } from "@/src/redux/userSlice";
import AuthUserNothave from "@/src/utils/AuthUserNothave";
import { OrderAllGet } from "@/src/utils/useOrder";
import { useWishlist } from "@/src/utils/useWishList";
import {
  Calendar,
  Camera,
  CreditCard,
...
import type { Order } from "@/src/services/order.service";
import type { Address } from "@/src/services/user.service";
        ...
        try {
          ...
          if (addressResponse.success && addressResponse.data) {
            ...
            if (addresses.length > 0) {
              const addr = addresses[0] as Address & {
                address_line?: string;
                division?: string;
              ...
              setAddressData({
                ...
                mobile: addr.mobile || addr.phone || data.mobile || "",
              });
            }
          }
        } catch (error) {
    ...
    try {
      ...
      if (
        ...
        if (isDOBNew) {
          ...
          console.log("DOB unchanged:", oldDOB);
        } else if (!newDOB) {
        ...
        toast.error(
          profileResponse.message || addressResponse.message || "Failed to update profile",
        );
      }
    } catch (error) {
                      ...
                      <div className="md:col-span-2 space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setAddressData({ ...addressData, address_line: e.target.value })
                            }
                            disabled={!isEditing}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setAddressData({ ...addressData, division: e.target.value })
                            }
                            disabled={!isEditing}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setAddressData({ ...addressData, upazila_thana: e.target.value })
                            }
                            disabled={!isEditing}
                  ...
                  <div className="p-4 md:p-8">
                    ...
                    <div className="space-y-4">
                      {orders.map((order, index) => {
                        ...
                        const image = firstProduct?.image || "/banner/img/placeholder.png";
                        ...
                        const totalAmt = order.total ?? order.subtotal ?? 0;
                      ...
                      {(wishlist || []).map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-lg font-bold text-blue-600 mb-3">à§³{price}</p>
                          ...
                          <div className="bg-white rounded-lg p-4 border border-emerald-100">
                            ...
                            <div className="flex flex-wrap gap-3">
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  {data.verify_email ? "âœ“ Email Verified" : "âš  Email Not Verified"}
                                </span>
                              </div>
                              <div className="flex items-center gap-2">
                                <span
