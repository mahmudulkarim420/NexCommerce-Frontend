    ...
    <div className="min-h-screen lg:mt-20 py-5 bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 text-white">
        ...
        >
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">à¦†à¦®à¦¾à¦¦à§‡à¦° à¦¬à§à¦²à¦—</h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              à¦¸à¦°à§à¦¬à¦¶à§‡à¦· à¦Ÿà§à¦°à§‡à¦¨à§à¦¡, à¦Ÿà¦¿à¦ªà¦¸ à¦à¦¬à¦‚ à¦—à¦¾à¦‡à¦¡ à¦ªà¦¡à¦¼à§à¦¨ à¦†à¦®à¦¾à¦¦à§‡à¦° expert à¦¦à§‡à¦° à¦•à¦¾à¦› à¦¥à§‡à¦•à§‡
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800">à¦«à¦¿à¦šà¦¾à¦°à§à¦¡ à¦ªà§‹à¦¸à§à¦Ÿ</h2>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 text-center">
              à¦¸à¦¾à¦®à§à¦ªà§à¦°à¦¤à¦¿à¦• à¦ªà§‹à¦¸à§à¦Ÿà¦¸à¦®à§‚à¦¹
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map((post, index) => (
              <div
                key={post._id}
                className={`bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 transition-all duration-500 cursor-pointer ${
                  isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
                }`}
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-600 mb-2">à¦•à§‹à¦¨à§‹ à¦ªà§‹à¦¸à§à¦Ÿ à¦ªà¦¾à¦“à¦¯à¦¼à¦¾ à¦¯à¦¾à¦¯à¦¼à¦¨à¦¿</h3>
              <p className="text-gray-500">
                à¦†à¦ªà¦¨à¦¾à¦° search term à¦¬à¦¾ category à¦ªà¦°à¦¿à¦¬à¦°à§à¦¤à¦¨ à¦•à¦°à§‡ à¦†à¦¬à¦¾à¦° à¦šà§‡à¦·à§à¦Ÿà¦¾ à¦•à¦°à§à¦¨à¥¤
              </p>
            </div>
          )}
        </div>
      ...
      <div className="py-16 bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">à¦¨à¦¤à§à¦¨ à¦ªà§‹à¦¸à§à¦Ÿà§‡à¦° à¦†à¦ªà¦¡à§‡à¦Ÿ à¦ªà¦¾à¦¨</h2>
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            à¦†à¦®à¦¾à¦¦à§‡à¦° newsletter subscribe à¦•à¦°à§à¦¨ à¦à¦¬à¦‚ à¦¸à¦°à§à¦¬à¦ªà§à¦°à¦¥à¦® à¦œà¦¾à¦¨à§à¦¨ à¦¨à¦¤à§à¦¨ à¦¬à§à¦²à¦— à¦ªà§‹à¦¸à§à¦Ÿ à¦à¦¬à¦‚ exclusive
            content à¦à¦° à¦•à¦¥à¦¾à¥¤
          </p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <button
              ...
              className="bg-white cursor-pointer text-teal-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transform hover:scale-105 transition-all duration-300"
            >
              {subscribe ? "subscribed" : "subscribe"}
            </button>
          </div>
          <p className="mt-5">
            {subscribe ? "à¦§à¦¨à§à¦¯à¦¬à¦¾à¦¦ à¦¸à¦¾à¦¬à¦¸à§à¦•à§à¦°à¦¾à¦‡à¦¬ à¦•à¦°à¦¾à¦° à¦œà¦¨à§à¦¯!" : "à¦¸à¦¾à¦¬à¦¸à§à¦•à§à¦°à¦¾à¦‡à¦¬ à¦•à¦°à§à¦¨"}
          </p>
        </div>
      </div>
