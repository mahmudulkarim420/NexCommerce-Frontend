        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 p-6">
                <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-xl font-semibold text-white">à¦…à¦žà§à¦šà¦² à¦“ à¦œà§‡à¦²à¦¾ à¦¨à¦¿à¦°à§à¦¬à¦¾à¦šà¦¨</h2>
                </div>
            </div>
            ...
            <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Division */}
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">à¦¬à¦¿à¦­à¦¾à¦—</label>
                        <select
                    ...
                    {/* District */}
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">à¦œà§‡à¦²à¦¾</label>
                        <select
                        ...
                        >
                            <option value="">-- à¦œà§‡à¦²à¦¾ à¦¨à¦¿à¦°à§à¦¬à¦¾à¦šà¦¨ à¦•à¦°à§à¦¨ --</option>
                    ...
                    <div className="md:col-span-2">
                        <label className="block text-sm font-semibold text-gray-700 mb-2">à¦‰à¦ªà¦œà§‡à¦²à¦¾ / à¦¥à¦¾à¦¨à¦¾</label>
                        <select
                        ...
                        >
                            <option value="">-- à¦‰à¦ªà¦œà§‡à¦²à¦¾ à¦¨à¦¿à¦°à§à¦¬à¦¾à¦šà¦¨ à¦•à¦°à§à¦¨ --</option>
