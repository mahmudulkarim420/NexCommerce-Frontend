                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-3 text-xs text-gray-600">
                          ...
                          <span>Price: <span className="font-medium text-gray-900">à§³{p.price || 0}</span></span>
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-5">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-gray-800">à§³{order.subTotalAmt || order.subtotal || 0}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Delivery Charge</span>
                <span className="font-semibold text-gray-800">à§³{order.deliveryCharge || 0}</span>
              </div>
              
              <div className="border-t border-cyan-200 pt-3 mt-3">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-green-600 font-medium">Amount Paid</span>
                  <span className="font-bold text-green-600">à§³{order.amount_paid || 0}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-red-600 font-medium">Amount Due</span>
                  <span className="font-bold text-red-600">à§³{order.amount_due || 0}</span>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 mt-4 border-2 border-teal-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-teal-600 font-bold text-xl">à§³{order.totalAmt || 0}</span>
                </div>
              </div>
            </div>
          </div>
