...
import { useGetProduct } from "@/src/utils/userProduct";
import {
  ChevronRight,
  Heart,
  Loader,
...
const ProductDetails = () => {
  ...
  const { data: wishlist } = useSelector((state: any) => state.wishlist);
          ...
          <div className="space-y-6">
            ...
            `}
                      >
                        ...
                        {isActive && (
                          <span className="text-white font-bold text-lg leading-none ml-1">âœ“</span>
                        )}
                      </button>
                    );
                  })}
