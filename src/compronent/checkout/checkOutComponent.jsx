  ...
  const handleManualOrderAndPaymentSubmission = async ({ payDeliveryOnly = false }) => {
    ...
    try {
      ...
      const msg =
        ...
        err?.message ||
        "ম্যানুয়াল অর্ডার ও পেমেন্ট জমা দিতে ব্যর্থ হয়েছে";
      toast.error(msg);
    } finally {
      setIsProcessing(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
                  ...
                  `}
                          ...
                          <div className="flex gap-2 pt-2">
                            ...
                            >
                              {isProcessing
                                ? "প্রসেসিং হচ্ছে..."
                                : `ডেলিভারি চার্জ দিন ৳${deliveryCharge}`}
                            </button>
                            <button
                              onClick={() =>
                            ...
                            >
                              {isProcessing
                                ? "প্রসেসিং হচ্ছে..."
                                : `সম্পূর্ণ পেমেন্ট দিন ৳${(subtotal + deliveryCharge).toLocaleString()}`}
                            </button>
                          </div>
                        </div>
                      )}
                        ...
                        createdOrder && (
                          <div className="mt-4 space-y-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
                            <h3 className="font-bold text-blue-800 text-lg">
                              ম্যানুয়াল পেমেন্ট নির্দেশাবলী
                            </h3>
                            <p className="text-sm text-blue-700">
                              আপনার অর্ডার <strong>#{createdOrder._id?.substring(0, 8)}</strong>{" "}
                              সফলভাবে তৈরি হয়েছে। অনুগ্রহ করে নিচের ধাপগুলো অনুসরণ করে পেমেন্ট
                              সম্পন্ন করুন।
                            </p>
                            ...
                            <p className="text-sm text-blue-700 mt-2">
                              পেমেন্ট করার পর, নিচের ফর্মে ট্রানজ্যাকশন আইডি এবং আপনার মোবাইল নম্বর
                              জমা দিন।
                            </p>
                      ...
                      {selectedPayment === "manual" && manualOrderStep === "payment_submitted" && (
                        <div className="mt-4 space-y-3 p-4 bg-green-50 rounded-xl border border-green-200 text-center">
                          ...
                          <p className="text-sm text-green-700">
                            আপনার পেমেন্টের তথ্য সফলভাবে জমা দেওয়া হয়েছে। অ্যাডমিনের কনফার্মেশনের
                            জন্য অপেক্ষা করুন। অর্ডার ID:{" "}
      ...
      `}
                ...
                <div className="space-y-3">
                  ...
                  >
                    {isProcessing ? "প্রসেসিং হচ্ছে..." : "One-Click SSL — Full"}
                  </button>
                  ...
                  >
                    {isProcessing ? "প্রসেসিং হচ্ছে..." : `Pay Delivery Only (৳${deliveryCharge})`}
                  </button>
