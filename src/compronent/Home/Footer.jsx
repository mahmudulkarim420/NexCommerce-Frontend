    ...
    <footer className="w-[98%] lg:w-[95%] mx-auto my-6">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4 lg:gap-0 py-4 px-2 lg:px-0">
        <div className="w-[400px] h-auto">
          <h3 className="text-[22px] font-bold text-black">NexCommerce</h3>
        ...
        <div className="w-[200px] h-auto mt-3 ">
          ...
          <div>
            <p className=" text-[16px] my-3 text-gray-500 hover:text-primary-color cursor-pointer hover:transition-al hover:ml-4 hover:duration-200">
      ...
      <div className=" flex flex-col md:flex-row justify-between items-center mt-3">
        <div>
          <p className=" text-center text-wrap text-gray-500 text-[16px] my-4">
            © 2023 NexCommerce. All rights reserved.
          </p>
        </div>
