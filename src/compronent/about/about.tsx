            ...
            >
              ...
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                <p className="mb-6 text-lg">
                  ২০১৯ সাল থেকে NexCommerce বাংলাদেশের মানুষের কাছে গুণগত পণ্য সাশ্রয়ী মূল্যে পৌঁছে
                  দেওয়ার লক্ষ্যে কাজ করে যাচ্ছে। আমাদের স্বপ্ন হলো প্রতিটি বাংলাদেশী পরিবারের কাছে
                  সহজ ও নিরাপদ অনলাইন শপিং সুবিধা পৌঁছে দেওয়া।
                </p>
                <p className="text-lg">
                  আমরা বিশ্বাস করি যে, প্রযুক্তির সঠিক ব্যবহারের মাধ্যমে আমরা মানুষের জীবনযাত্রার
                  মান উন্নয়নে অবদান রাখতে পারি। তাই আমাদের প্রতিটি সেবা ডিজাইন করা হয়েছে গ্রাহকের
                  সুবিধাকে মাথায় রেখে।
                </p>
              </div>
            </div>
          </div>
