...
const ShippingSettings = () => {
  ...
  const toggleZoneStatus = (id) => {
    setShippingZones(
      shippingZones.map((zone) => (zone.id === id ? { ...zone, isActive: !zone.isActive } : zone)),
    );
  };
  ...
  const Card = ({ children, className = "" }) => (
    <div
      className={`bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl border border-gray-700 ${className}`}
    >
      {children}
    </div>
  );
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewMethod({
                      ...newMethod,
                      zones: Array.from(e.target.selectedOptions, (option) =>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {shippingMethods.map((method) => (
                <Card
                  key={method.id}
                  className="p-6 hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-1"
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`p-2 rounded-lg ${method.isActive ? "bg-green-500" : "bg-red-500"}`}
                      >
              ...
              {shippingZones.map((zone) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`p-2 rounded-lg ${zone.isActive ? "bg-green-500" : "bg-red-500"}`}
                      >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Allow free shipping for orders above threshold
                    </p>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setGeneralSettings({ ...generalSettings, processingTime: e.target.value })
                    }
                    className="w-full bg-gray-700 text-white rounded-lg px-4 py-3 border border-gray-600 focus:border-blue-500 focus:outline-none transition-colors"
                  />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Enable shipping cost calculator on frontend
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        setGeneralSettings({
                          ...generalSettings,
                          enableShippingCalculator: e.target.checked,
                        })
                      }
                      className="sr-only peer"
                    />
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setGeneralSettings({ ...generalSettings, weightUnit: e.target.value })
                    }
                    className="w-full bg-gray-700 text-white rounded-lg px-4 py-3 border border-gray-600 focus:border-blue-500 focus:outline-none transition-colors"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setGeneralSettings({ ...generalSettings, dimensionUnit: e.target.value })
                    }
                    className="w-full bg-gray-700 text-white rounded-lg px-4 py-3 border border-gray-600 focus:border-blue-500 focus:outline-none transition-colors"
                  >
