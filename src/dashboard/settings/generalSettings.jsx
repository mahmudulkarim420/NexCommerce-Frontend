                  ...
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    <div className="grid md:grid-cols-4 gap-4">
                      ...
                      <div>
                        ...
                        >
                          {timezones.map((timezone) => (
                            <option className="bg-gray-700" key={timezone} value={timezone}>
                              {timezone}
                            </option>
                          ))}
                        </select>
                      ...
                      <div>
                        ...
                        >
                          {languages.map((lang) => (
                            <option className="bg-gray-700" key={lang} value={lang}>
                              {lang.toUpperCase()}
                            </option>
                          ))}
                        </select>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                        >
                          <option className="bg-gray-700" value="smtp">
                            SMTP
                          </option>
                          <option className="bg-gray-700" value="sendgrid">
                            SendGrid
                          </option>
                          <option className="bg-gray-700" value="mailgun">
                            Mailgun
                          </option>
                        </select>
                      </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                        >
                          <option className="bg-gray-700" value="weak">
                            Weak
                          </option>
                          <option className="bg-gray-700" value="medium">
                            Medium
                          </option>
                          <option className="bg-gray-700" value="strong">
                            Strong
                          </option>
                        </select>
                      </div>
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          desc: "Notifications about customer activities",
                        },
                      ].map((item) => (
                        <div
                          key={item.key}
                      ...
                      {[
                        {
                          ...
                          desc: "Accept Visa, Mastercard, etc.",
                        },
                  ...
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                      >
                        <option className="bg-gray-700" value="weight">
                          By Weight
                        </option>
                        <option className="bg-gray-700" value="price">
                          By Price
                        </option>
                        <option className="bg-gray-700" value="quantity">
                          By Quantity
                        </option>
                        <option className="bg-gray-700" value="fixed">
                          Fixed Rate
                        </option>
                      </select>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        >
                          ...
                          <option className="bg-gray-700" value="24">
                            24
                          </option>
                          <option className="bg-gray-700" value="48">
                            48
                          </option>
                        </select>
                      </div>
                      ...
                      {[
                        {
                          ...
                          desc: "Display products that are out of stock",
                        },
                        {
                          key: "enableWishlist",
                          label: "Enable Wishlist",
                          desc: "Allow customers to save products to wishlist",
                        },
                        {
                          key: "enableReviews",
                          label: "Enable Product Reviews",
                          desc: "Allow customers to review products",
                        },
                      ].map((item) => (
                        <div
                          key={item.key}
