      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div
              className={`p-3 rounded-lg bg-gradient-to-r ${config.enabled ? "from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/25" : "from-gray-600 to-gray-700"}`}
            >
        ...
        {config.enabled && (
          <div className="space-y-4 animate-fadeIn">
            {Object.entries(config).map(([key, value]) => {
              ...
              const isSecret =
                key.includes("secret") || key.includes("password") || key.includes("Secret");
                  ...
                  <div className="relative">
                    {typeof value === "boolean" ? (
                      <select
                        ...
                        onChange={(e) =>
                          handleSettingChange(gateway, key, e.target.value === "true")
                        }
                        className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 transition-all duration-200"
                      >
                      ...
                      <>
                        <input
                          ...
                          className="w-full px-3 py-2 pr-10 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 transition-all duration-200 placeholder-gray-400"
            ...
            <div className="flex space-x-2 pt-4">
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 hover:scale-105"
              >
      ...
      <div className="transition-all  duration-500  lg:ml-10 lg:px-9">
          ...
          <div className="relative bg-gradient-to-r from-gray-900/80 via-blue-900/80 to-purple-900/80 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-gray-700/50 shadow-2xl shadow-blue-500/10 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-gray-300 text-sm sm:text-base">NexCommerce Admin Dashboard</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="animate-fadeIn">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleGeneralSettingChange("defaultCurrency", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleGeneralSettingChange("minimumAmount", parseFloat(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleGeneralSettingChange("maximumAmount", parseFloat(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleGeneralSettingChange("transactionFee", parseFloat(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 placeholder-gray-400"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleGeneralSettingChange("paymentTimeout", parseInt(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleGeneralSettingChange("taxRate", parseFloat(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-400 placeholder-gray-400"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-green-900/50 to-emerald-900/50 rounded-lg border border-green-700">
                    ...
                    <p className="text-sm text-green-400 mt-1">
                      Your site is protected with SSL encryption
                    </p>
                  </div>
          ...
          {activeTab === "currencies" && (
            <div className="bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800 rounded-xl shadow-2xl p-6 border border-gray-600">
              <h3 className="text-lg font-semibold text-white mb-4">Supported Currencies</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {["BDT", "USD", "EUR", "GBP", "JPY", "CAD"].map((currency) => (
                  <div
                    key={currency}
                    className="flex items-center justify-between p-3 border border-gray-600 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors"
                  >
        ...
        <div className="fixed bottom-6 right-6">
          <button
            ...
            className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-full shadow-2xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 flex items-center space-x-2 hover:scale-105 border border-green-500 shadow-green-600/25 hover:shadow-green-600/40"
          >
