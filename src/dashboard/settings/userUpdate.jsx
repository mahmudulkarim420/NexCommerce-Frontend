...
export default function UserRoleManager() {
  // Get all users
  const { allusers, loading: fetchLoading, error, refetch } = useGetAllUser();
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div
                    className={`${getRoleColor(user?.role)} w-14 h-14 rounded-xl flex items-center justify-center text-2xl shadow-lg`}
                  >
                    {user?.image ? (
                      <img
                        src={user?.image}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      <span
                        className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${getStatusColor(user?.status)} text-white`}
                      >
                        {user?.status}
                      </span>
                      {user?.verify_email && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditingUser({ ...editingUser, customerstatus: e.target.value })
                    }
                    className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
                ...
                <div className="md:col-span-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        setEditingUser({ ...editingUser, verify_email: e.target.checked })
                      }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditingUser({ ...editingUser, last_login_date: e.target.value })
                    }
                    className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <p className="text-white text-xl font-bold">
                      {editingUser.address_details?.length || 0}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-xs mb-1">Cart Items</p>
                    <p className="text-white text-xl font-bold">
                      {editingUser.shopping_cart?.length || 0}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-xs mb-1">Orders</p>
                    <p className="text-white text-xl font-bold">
                      {editingUser.orderHistory?.length || 0}
                    </p>
                  </div>
                </div>
              </div>
