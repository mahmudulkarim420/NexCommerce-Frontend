...
const ShippedOrdersPage = () => {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const matchesPayment =
      filterBy === "all" || order.paymentMethod.toLowerCase() === filterBy.toLowerCase();
  ...
  const handleMarkAsDelivered = (orderId) => {
    setOrders(
      orders.map((order) => (order.id === orderId ? { ...order, status: "delivered" } : order)),
    );
  };
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-800/50 p-4 rounded-lg space-y-3">
                      ...
                      <button
                        onClick={() =>
                          handleTrackOrder(selectedOrder.trackingNumber, selectedOrder.carrier)
                        }
