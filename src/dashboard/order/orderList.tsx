...
const statusColors = {
  pending:
    "bg-gradient-to-r from-yellow-400 to-orange-400 text-white shadow-lg shadow-yellow-500/25",
              ...
              <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
                <div className="flex flex-col sm:flex-row gap-4 flex-1 w-full">
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      <option className="bg-[#1A2533]" value="all">
                        All Status
                      </option>
                      <option className="bg-[#1A2533]" value="pending">
                        Pending
                      </option>
                      <option className="bg-[#1A2533]" value="processing">
                        Processing
                      </option>
                      <option className="bg-[#1A2533]" value="shipped">
                        Shipped
                      </option>
                      <option className="bg-[#1A2533]" value="completed">
                        Completed
                      </option>
                      <option className="bg-[#1A2533]" value="cancelled">
                        Cancelled
                      </option>
                    </select>
                    ...
                    >
                      ...
                      <option className="bg-[#1A2533]" value="high">
                        High Priority
                      </option>
                      <option className="bg-[#1A2533]" value="medium">
                        Medium Priority
                      </option>
                      <option className="bg-[#1A2533]" value="low">
                        Low Priority
                      </option>
                    </select>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <option className="bg-[#1A2533]" value="orderDate">
                        Date
                      </option>
                      <option className="bg-[#1A2533]" value="total">
                        Amount
                      </option>
                      <option className="bg-[#1A2533]" value="customerName">
                        Customer
                      </option>
                      <option className="bg-[#1A2533]" value="status">
                        Status
                      </option>
                    </select>
                  </div>
