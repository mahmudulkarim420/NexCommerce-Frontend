...
const InventoryDashboard = () => {
  ...
  const stats = useMemo(() => {
    ...
    const lowStockProducts = products.filter(
      (p) => p.productName <= lowStockThreshold && p.productStock > 0,
    ).length;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {filteredProducts.map((product, index) => {
                    ...
                    const stockPercentage = Math.min(
                      (product?.productStock / (lowStockThreshold * 2)) * 100,
                      100,
                    );
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <div className="space-y-1">
                              <span
                                className={`inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-gradient-to-r ${getStatusColor(product?.productStock)} text-white shadow-md`}
                              >
                          ...
                          <div className="flex space-x-2 pt-2">
                            ...
                            <button
                              ...
                              className="flex-1 flex items-center justify-center space-x-1 py-2 bg-emerald-500/20 text-emerald-300 rounded-xl hover:bg-emerald-500/30 transition-all duration-200 hover:scale-105 font-medium"
                            >
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-gradient-to-r from-purple-600/50 via-pink-600/50 to-rose-600/50 border-b border-white/20">
                          ...
                          <th className="px-6 py-4 text-left font-bold text-white hidden md:table-cell">
                            SKU
                          </th>
                          <th className="px-6 py-4 text-left font-bold text-white hidden lg:table-cell">
                            Category
                          </th>
                            ...
                            >
                              <td className="px-6 py-4">
                                <div className="flex items-center space-x-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-sm text-white/60 md:hidden">
                                      SKU: {product?.sku}
                                    </div>
                                  </div>
                                </div>
                              ...
                              <td className="px-6 py-4">
                                <div className="flex space-x-2">
                                  ...
                                  <button
                                    onClick={() => handleView(product)}
                                    className="p-2 text-emerald-300 hover:bg-emerald-500/20 rounded-xl transition-all duration-200 hover:scale-110"
                                  >
                                    <Eye className="w-4 h-4" />
                                  </button>
                                  <button
