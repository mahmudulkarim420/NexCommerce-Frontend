    ...
    <div className="relative w-[98%]   mx-auto mt-6 group">
        ...
        <div className="relative w-full h-full">
          {slides?.map((slide, index) => (
            ...
            >
              <img
                src={
                  slide?.image || (Array.isArray(slide?.images) ? slide?.images[0] : null) || null
                }
      ...
      <div className="hidden lg:flex justify-center mt-4 space-x-2">
        {slides?.map((slide, index) => (
          ...
          >
            <img
              src={slide?.image || (Array.isArray(slide?.images) ? slide?.images[0] : null) || null}
              alt={slide?.title || "Banner Thumbnail"}
