        ...
        <div className="mb-8">
          <div className="relative w-32 h-32 mx-auto mb-6">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className={`p-4 rounded-full bg-gradient-to-r ${steps[currentStep].color} transform transition-all duration-500 scale-110`}
              >
          ...
          {/* Progress Percentage */}
          <div className="text-4xl font-bold text-white mb-2 font-mono">{progress}%</div>
        </div>
