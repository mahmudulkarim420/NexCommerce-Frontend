      ...
      <div className="max-w-md w-full bg-white shadow-2xl rounded-2xl p-8 text-center">
        ...
        <div className="mt-6 space-y-2">
          ...
          <p className="text-sm text-gray-700">
            ...
            <a href="tel:+8801626420774" className="text-red-600 hover:underline">
              +8801626420774
            </a>
          </p>
          <p className="text-sm text-gray-700">
            <strong>Email:</strong>{" "}
            <a href="mailto:support@nexcommerce.com" className="text-red-600 hover:underline">
              support@nexcommerce.com
            </a>
          </p>
        </div>
      </div>
