...
import { UserSignin } from "@/src/hook/useAuth";
...
const Signin = () => {
  ...
  const handleGoogleSignIn = async () => {
    toast("Google sign-in is temporarily disabled during the Better Auth migration.");
  };
        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-[95%] md:w-[500px] lg:w-[600px] ">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-16">
            <div className=" w-full">
              <Box component="form" className=" w-full! space-y-4!" noValidate autoComplete="off">
            ...
            <button
              type="submit"
              className="w-full bg-primary-color text-white py-2 rounded-md hover:bg-[#609283] cursor-pointer transition duration-200"
            >
              Sign In
            </button>
