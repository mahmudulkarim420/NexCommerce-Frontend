...
const ForgotPassword = () => {
  ...
  const handleChangePassword = () => {
    ...
    changePassword({ email, newpassword: newPassword })
      ...
      .catch((err) => {
        setError(
          err.response?.data?.message || "Password change kora jaini. Punarbar chesta korun.",
        );
      })
      .finally(() => {
        setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -right-40 w-80 h-80 bg-white rounded-full mix-blend-overlay filter blur-3xl opacity-20 animate-pulse"
